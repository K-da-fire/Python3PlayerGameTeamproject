...
def draw_ui(canvas, canvas_width, UI_HEIGHT,
    ...
    canvas.create_text(p1_section_x + section_width / 2, UI_HEIGHT - 15, text="C V B", font=("Arial", 10), fill="darkgray", anchor="center")
    ...
    canvas.create_text(p2_section_x + section_width / 2, UI_HEIGHT - 15, text="< > ?", font=("Arial", 10), fill="darkgray", anchor="center")
    ...
    total_p3_skill_bar_width = 60 * len(p3_skills.skills) + 10 * (len(p3_skills.skills) - 1)
    ...
    if total_p3_skill_bar_width > section_width:
        ...
        skill_bar_start_x_p3 = p3_section_x + (section_width - total_p3_skill_bar_width) / 2 # 가운데 정렬
        if skill_bar_start_x_p3 < p3_section_x + 5: # 섹션 왼쪽 경계를 넘지 않도록
            skill_bar_start_x_p3 = p3_section_x + 5
    else:
        skill_bar_start_x_p3 = p3_section_x + (section_width - total_p3_skill_bar_width) / 2


    draw_skill_bar(canvas, skill_bar_start_x_p3, 40, p3_selected, p3_skills.skills)
    canvas.create_text(p3_section_x + section_width / 2, UI_HEIGHT - 15, text="Q E (click)", font=("Arial", 10), fill="darkgray", anchor="center")
